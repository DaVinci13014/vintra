...
describe("calculateGoalPlan", () => {
  it("calcule un plan réaliste et sa progression", () => {
    const result = calculateGoalPlan(
      { targetAmount: 10_000, currentAmount: 2_500, targetDate: new Date("2028-07-01"), savingCapacity: 500, profileType: "BALANCED" },
      new Date("2026-07-01"),
    );
  ...
  it("termine automatiquement un objectif atteint", () => {
    const result = calculateGoalPlan({ targetAmount: 1_000, currentAmount: 1_200, targetDate: new Date("2027-01-01"), savingCapacity: 0, profileType: "FRAGILE" });
